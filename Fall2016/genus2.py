...
non_one = nona.Nonahedron_ring(x_edge, height_corner, top_z)
non_two = nona.Nonahedron_ring(x_edge, height_corner, top_z, 2*x_edge, 0, 0, 0, top_z)
nons = [non_one, non_two]
...
def main():
	...
	glutCreateWindow("Nonahedron genus 2 figure")
